...
import { Plus, X, Target, Settings, Shield, FileText } from "lucide-react";
...
export default function StreakCreateManagementClient() {
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 w-full">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Create New Streak</h1>
          <p className="text-muted-foreground">
            Create a new streak challenge with advanced management settings.
          </p>
        </div>
