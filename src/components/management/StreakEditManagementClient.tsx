...
import { Plus, X, Shield, FileText, Target, Settings } from "lucide-react";
...
interface StreakEditManagementClientProps {
  streakId: string;
}

export default function StreakEditManagementClient({ streakId }: StreakEditManagementClientProps) {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const _streakId = streakId;
  const router = useRouter();
  
  // Mock streak data - in real app this would be fetched by ID
  ...
  const handleSubmit = () => {
    ...
    console.log("Updating streak:", {
      ...
      creatorId: "admin", // In real app, this would be the current admin user
      creatorName: "Admin",
    });

    // Redirect to streaks management page
    router.push('/management/streaks');
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Update streak challenge with advanced management settings.
          </p>
        </div>
        ...
        <Tabs value={currentStep.toString()} onValueChange={(value) => setCurrentStep(parseInt(value))} className="space-y-6">
          <TabsList className="grid grid-cols-5">
            ...
            <TabsTrigger value="4">Legal</TabsTrigger>
            ...
            <Card>
              ...
              <CardContent>
                <Textarea
                  ...
                  placeholder="Enter the privacy policy for this streak..."
                />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <Textarea
                  ...
                  className="min-h-[150px]"
                  placeholder="Enter the terms and conditions for this streak..."
                />
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="acceptTerms">
                    I have read and accept the terms and conditions for updating this streak
                  </Label>
                </div>
              </CardContent>
            </Card>
