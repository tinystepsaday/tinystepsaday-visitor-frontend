      ...
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center flex-col gap-4 w-full">
          ...
          <div className="flex flex-col items-start justify-start w-full gap-2">
            <div className="h-8 w-64 bg-gray-200 rounded animate-pulse" title={title}></div>
            <div className="h-4 w-96 bg-gray-200 rounded animate-pulse" title={subtitle}></div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <div className="h-8 w-64 bg-gray-200 rounded animate-pulse" title={title}></div>
          <div className="h-4 w-96 bg-gray-200 rounded animate-pulse mt-2" title={subtitle}></div>
        </div>
        {createHref ? (
          <Button disabled>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex flex-col items-start gap-4 w-full">
          ...
          <div>
            <div className="h-8 w-64 bg-gray-200 rounded animate-pulse" title={title}></div>
            <div className="h-4 w-48 bg-gray-200 rounded animate-pulse mt-2" title={subtitle}></div>
          </div>
        </div>
      </div>
